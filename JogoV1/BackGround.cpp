...
void BackGround::setUpFundo()
{
	if (fundoJogo == 0)
	{
		std::string nomeImg = "assets/frame_00_delay-0.08s.jpg";
	...
	{
		std::string nomeImg = "assets/frame_00_delay-0.06s.gif";
	...
	{
		std::string nomeImg = "assets/frame_00_delay-0.06s.jpg";
